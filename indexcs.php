...
xmlhttp.onreadystatechange=function()
 ...
 <a href="indexcs.php" style="color:#00FF66;" target="_top" title="Compile and Execute C Sharp (mono) Programs Online" >C#</a>
 </div>
 <div id="right">
  ...
  <div>
   ...
   <button class="but2"   name="save" value='Run' onClick="getVal()" ><center> RUN YOUR PROGRAM </center></button>   
  	...
  	<input type="hidden" name="code1" id="code1" value="" />
        <input type="hidden" name="ext" id="ext" value="cs"/>

	<div id="sample"  name="sample";>	
<?php

$dh=opendir("sample/cs");
